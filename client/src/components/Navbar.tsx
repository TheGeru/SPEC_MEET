    ...
    <nav className="bg-zinc-900 border-b border-zinc-800 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Botón Menú Móvil / Desktop (Usas el mismo para ambos según tu código) */}
          <div className="block"> 
      ...
      {/* Menú Desplegable */}
      {isMenuOpen && (
        <div className="bg-zinc-900 shadow-lg absolute right-0 z-50 w-64 py-2 border border-zinc-800 rounded-b-lg">
